...
- [Lambda — Collaborative Coding Classroom](#lambda--collaborative-coding-classroom)
  ...
  - [Key Technical Decisions](#key-technical-decisions)
    - [1. Sandboxed Code Execution](#1-sandboxed-code-execution)
    - [2. Real-Time Collaboration via CRDT](#2-real-time-collaboration-via-crdt)
    - [3. Layered Service Architecture](#3-layered-service-architecture)
  ...
  - [Development Milestones](#development-milestones)
    ...
    - [Phase 2 — MVP Backend (`v1 - MVP`)](#phase-2--mvp-backend-v1---mvp)
    - [Phase 3 — Authentication \& Frontend (`v2-frontend`)](#phase-3--authentication--frontend-v2-frontend)
    - [Phase 4 — Sandbox Execution (`v2`)](#phase-4--sandbox-execution-v2)
    - [Phase 5 — Real-Time Collaboration (`CRDT`)](#phase-5--real-time-collaboration-crdt)
    - [Phase 6 — UI Polish (`user label added`, `UI fix`)](#phase-6--ui-polish-user-label-added-ui-fix)
  - [Getting Started](#getting-started)
    - [Prerequisites](#prerequisites)
    - [Backend Setup](#backend-setup)
    - [Frontend Setup](#frontend-setup)
    - [Docker Sandbox (Optional)](#docker-sandbox-optional)
